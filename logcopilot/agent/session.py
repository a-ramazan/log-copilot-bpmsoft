...
class AgentSessionState:
    # Последний "сфокусированный" incident cluster. Нужен для follow-up вопросов:
    # "в чем проблема?", "как исправить?", "почему это происходит?".
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "last_top_cluster_ids": list(self.last_top_cluster_ids),
    ...
    def from_dict(cls, payload: dict | None) -> "AgentSessionState":
        ...
        return cls(
            ...
            last_top_cluster_ids=list(payload.get("last_top_cluster_ids", [])),
